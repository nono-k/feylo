...
<template>
  <footer class="footer">
    <div class="footer__keywords">
      <h2 class="footer__heading">キーワードから探す💬</h2>
    ...
    <div class="footer__content">
      <h2 class="footer__heading">コンテンツ一覧📦</h2>
...
.footer {
  ...
  &__content-item {
    ...
    transition-timing-function: cubic-bezier(0.35, 2.5, 0.7, 0.65);
    @include mixin.hover {
      translate: 0 -1rem
    }
  }
